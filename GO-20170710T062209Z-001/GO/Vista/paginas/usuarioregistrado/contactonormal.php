...
<body class="home">
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li><a href="principanormal.php#home">Inicio</a></li>
					<li><a href="principanormal.php#acerca">Acerca</a></li>
					<li><a href="galerianormal.php">Galeria</a></li>	
					<li class="active"><a href="contactonormal.php">Contacto</a></li>
	...
	<br><br><br><br><br>
	<!-- /Contacto -->
	<link rel="stylesheet" type="text/css" href="../../css/csscontacto/contac.css">
	<form class="contactacme" action="enviar.php" method="post">
		<font color="white"><h2>Contacto</h2></font>
		<input class="fodos" type="text" name="Nombre" placeholder="Nombre" required>
		<br></br>
		<input class="fodos" type="text" name="Correo" placeholder="Correo" required>
				<br></br>

		<input class="fodos" type="text" name="Telefono" placeholder="Telefono" required>
				<br></br>

		<textarea class="fotarea"name="Mensaje" placeholder="Escriba aqui su mensaje" required></textarea>
				<br></br>

		<input class="button" type="button" value="Enviar" id="boton">
	</form>
